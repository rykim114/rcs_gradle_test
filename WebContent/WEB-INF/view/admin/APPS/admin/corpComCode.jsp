                ...
                <div class="card card-custom card-stretch rounded-0">
                    ...
                    <div class="card-header align-items-center border-bottom">
                        <h3 class="card-title align-items-center">
                            <span class="font-weight-bolder text-dark">법인공통코드 관리</span>
                        </h3>
                          ...
                          <div class="row">
                              <div class="col-md-4">
                                  <div class="d-flex justify-content-between align-items-end h-40px">
                                      <h3 class="font-size-h5">법인마스터코드</h3>
                             ...
                             <!--              <button class="btn btn-square btn-outline-secondary btn-md ml-2" data-toggle="modal" data-target="#kt_auth_modal">수정</button> 
                                  ...
                                  <div class="border mt-4 nav-auth-wrap h-700px overflow-auto">
                                      <div class="datatable datatable-bordered datatable-head-custom" id="CorpCodeTable"></div>                                        
                                  </div>
                              </div>    
                              <div class="col-md-8 pl-md-10" id="corpDetail_1">
                                  <div class="d-flex justify-content-between align-items-end h-40px">
                                      <h3 class="font-size-h5">법인상세코드</h3>                                                                      
                                      <div>
                                  ...
                                  <div class="border mt-4 h-700px overflow-auto">
                                      <div class="datatable datatable-bordered datatable-head-custom" id="CorpDetailCodeTable_1"></div>                                        
                                  </div>
                              </div>   
<!--                               <div class="col-md-4" id="corpDetail_2">
                                  <div class="d-flex justify-content-between align-items-end h-40px">
                                      <h3 class="font-size-h5">법인상세세부코드</h3>
                                      <div>
                                          <button onclick="detailModal_2();" class="btn btn-square btn-outline-danger btn-md" data-toggle="modal">등록</button>
                                      </div>
                                  </div>
                                  <div class="border mt-4 nav-auth-wrap h-700px overflow-auto">
                                      <div class="datatable datatable-bordered datatable-head-custom" id="CorpDetailCodeTable_2"></div>                                        
                                  </div>
                              </div>  -->   
                          </div>
                      </div>
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="border-0">
                                    <input id="corpCode" class="form-control form-control-solid border border-secondary rounded-sm" type="text" value="" placeholder="코드를 입력해주세요">
                                </td>
                            </tr>
                            <tr>
                                <th>
                                ...
                                <td>
                                    <input id="corpCodeName" class="form-control form-control-solid border border-secondary rounded-sm" maxlength="12" type="text" value="" placeholder="코드명을 입력해주세요">
                                </td>
                            </tr>
                            <tr>
                                <th>
                                ...
                                <td>
                                    <input id="corpCodeSort" class="form-control form-control-solid border border-secondary rounded-sm" type="text" value="" placeholder="">
                                </td>
                            </tr>
                            <tr>
                                <th>
