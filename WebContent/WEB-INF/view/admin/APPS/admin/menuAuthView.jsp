        ...
        <div class="card card-custom card-stretch rounded-0">
            ...
            <div class="card-header align-items-center border-bottom">
                <h3 class="card-title align-items-center">
                    <span class="font-weight-bolder text-dark">메뉴상세</span>
                </h3>
            ...
            <div class="card-body pt-9">
                ...
                <div class="text-center mt-16">
                    <a href="javascript:;" class="btn btn-outline-secondary btn-lg px-11 font-weight-bold" onclick="menuList();">목록</a>
                </div>
                <!--end: Write Form-->
            </div>
		</div>
