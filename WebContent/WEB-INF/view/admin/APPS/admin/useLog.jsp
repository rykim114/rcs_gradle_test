                           ...
                           <div class="card card-custom card-stretch rounded-0">
                               ...
                               <div class="card-body pt-9">
                                   ...
                                   <ul class="nav nav-tabs nav-tabs-line nav-tabs-line-2x nav-tabs-line-danger">
                                       <li class="nav-item">
                                           <a class="nav-link active font-size-lg px-5" href="#" onclick="userCount();">접속자리스트</a>
                                       </li>
                                       <li class="nav-item">
                                       ...
                                       <li class="nav-item">
                                           <a class="nav-link font-size-lg px-5" href="#" onclick="downloadCount();">주요 다운로드 메뉴</a>
                                       </li>
                                   </ul>
                                   <!--end:: Nav Line -->
                                   <!--begin: Search Form-->
								...
								<div class="row align-items-center">
									<div class="col-lg-9 col-xl-8">
										<div class="row align-items-center">
											...
											<button type="button" onclick="dateSearch();" class="btn btn-dark btn-search dateSearch px-6">검색</button>
											</div>
										</div>
									</div>
