		...
		<div class="card card-custom card-stretch rounded-0">
			...
			<div class="card-body pt-9">
				...
				<ul class="nav nav-tabs nav-tabs-line nav-tabs-line-2x nav-tabs-line-danger">
				    <li class="nav-item">
				        <a class="nav-link font-size-lg px-5" href="javascript:;" onclick="userCount();">접속자수</a>
					</li>
					<li class="nav-item">
					    <a class="nav-link active font-size-lg px-5" href="javascript:;" onclick="menuCount();">메뉴별/버튼 클릭수</a>
					</li>
					<li class="nav-item">
				...
				<div class="mt-9 mb-7" data-wrapper="searchDetail">
					<div class="row align-items-center">
						<div class="searchTerm">
							...
							<div class="input-daterange input-group" data-search-time>
								<input type="text" class="form-control" name="startYMD" placeholder="연도 선택" />
								<span class="input-group-text border-left-0" data-btn-time>
						...
						<div class="ml-10 col-lg-3 col-xl-4">
				...
				<div class="row mt-15">
					<div class="col-5 pr-5">
						<div class="section" data-wrapper="tableLogClick">
							...
							<div data-scroll="true" data-height="430">
						...
						<div class="section mt-10" data-wrapper="tableLogStayTime">
							<h4 class="d-flex align-items-center justify-content-between">
								메뉴별 체류시간
								<button type="button" class="btn btn-outline-secondary btn-sm rounded-0 px-3 py-1" data-btn-download>
									<i class="flaticon-download icon-md"></i>
					...
					<div class="col-7 pl-5">
					    <div class="row" data-wrapper="tableLogMinMax">
							...
							<div class="col-6 pl-5">
								<div class="section">
									<h4>최대 체류시간 항목</h4>
									<div class="ranking-wrap">
										<ul data-list="staytime-max">
										</ul>
									</div>
								</div>
							</div>
							<div class="col-6 pr-5 mt-10">
								<div class="section">
									<h4>최소 클릭 항목</h4>
									<div class="ranking-wrap">
										<ul data-list="click-min">
										</ul>
									</div>
								</div>
							</div>
							<div class="col-6 pl-5 mt-10">
								<div class="section">
									<h4>최소 체류시간 항목</h4>
									<div class="ranking-wrap">
										<ul data-list="staytime-min">
										</ul>
									</div>
								</div>
							</div>
						...
						<div class="section mt-16">
							<div class="">
								<h4>클릭수 및 체류시간 그래프</h4>
								<div id="useLogClickStayTime"></div>
							</div>
				        </div>
				    </div>
				</div>
...
{{#each dataArr}}
	<li>
		<div>
			<label data-toggle="tooltip" data-placement="left" data-width="auto" title="{{메뉴명}}">{{메뉴명}}</label>
