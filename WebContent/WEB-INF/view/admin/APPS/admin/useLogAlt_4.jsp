			...
			<div class="card-body pt-9">
				...
				<ul class="nav nav-tabs nav-tabs-line nav-tabs-line-2x nav-tabs-line-danger">
				   <li class="nav-item">
					...
					<li class="nav-item">
				   		<a class="nav-link active font-size-lg px-5" href="javascript:;" onclick="downloadCount();">주요 다운로드 메뉴</a>
				    </li>
				</ul>
				<!--end:: Nav Line -->
                <!--begin: Search Form-->
				...
				<!--begin: row-->
				<div class="row pt-10">
					<div class="col-5 pr-5" data-wrapper="tableLogClick">
						<h4 class="d-flex align-items-center justify-content-between">
							<label>다운로드 항목</label>
							<button type="button" class="btn btn-outline-secondary btn-sm rounded-0 px-3 py-1"><i class="flaticon-download icon-md" data-btn-download></i> 다운로드</button>
						</h4>
						<table class="table-vertical" data-table="head">
                         ...
                         <div data-scroll="true" data-height="560">
                             <table class="table-vertical" data-table="body">
                                 <colgroup>
									<col width="80px">
									<col width="*">
									<col width="220px">
					...
					<div class="col-7 pl-5">
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="mt-md-10">
                                    <h4>다운로드 통계(엑셀/그래프)</h4>
                                    <div id="useLogDownloadStatistics"></div>
                                </div>
                            </div>
                        </div>
                    </div>
...
{{#each dataArr}}
	<li>
		<div>
			<label data-toggle="tooltip" data-placement="left" data-width="auto" title="{{주요다운로드}}">{{주요다운로드}}</label>
