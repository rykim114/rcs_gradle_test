                                ...
                                <div class="card card-custom card-stretch rounded-0">
                                    ...
                                    <div class="card-body pt-9">
                                        ...
                                        <ul class="nav nav-tabs nav-tabs-line nav-tabs-line-2x nav-tabs-line-danger">
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link active font-size-lg px-5" href="#" onclick="menuCount();">메뉴별/버튼 클릭수</a>
                                            </li>
                                            <li class="nav-item">
												...
												<div class="col-lg-9 col-xl-8">
													<div class="row align-items-center">
														...
														<div class="col-md-4 my-2 my-md-0">
															<button type="button" class="btn btn-dark btn-search px-6" onclick="dateSearch();">검색</button>
														</div>
													</div>
												</div>
