		...
		<div class="card card-custom card-stretch rounded-0">
			...
			<div class="card-header align-items-center">
				<h3 class="card-title align-items-center">
					<span class="font-weight-bolder text-dark">공급동향(분양)</span>
				</h3>
									...
									<h3 class="mb-5 changeTitle" data-select-sgg>
										...
										<i class="fa fa-question-circle icon-md ml-3 tooltipCustom">
											<span class="tooltipCustom-text">
												부동산R114가 자체 분류한 8가지 상가유형에 따라 연도별,면적별 상가 공급(분양)정보를 제공합니다.
												<br>
												<br>
								...
								<div class="mb-2">
									<div class="row align-items-end">
										...
										<div class="col-lg-9 col-xl-8 text-right">
											<!-- 201215 버튼추가 -->
											<button type="button" class="btn btn-outline-secondary btn-sm rounded-0 px-3 py-1" data-btn-download="table_5_3"><i class="flaticon-download icon-md"></i> 다운로드</button>
										</div>
									</div>
								</div>	
							...
							<div class="position-relative pb-10 mb-10" data-table-wrapper="table_5_2" style="display: none;">
								...
								<div class="mb-2">
									<div class="row align-items-end">
										...
										<div class="col-lg-9 col-xl-8 text-right">
											<!-- 201215 버튼추가 -->
											<button type="button" class="btn btn-outline-secondary btn-sm rounded-0 px-3 py-1" data-btn-download="table_5_2"><i class="flaticon-download icon-md"></i> 다운로드</button>
										</div>
									</div>
								</div>
...
<c:out value="<script type='text/template' id='tmplTableSupplyTrendSanggaType'>" escapeXml="false" />
{{#each dataArr}}
	{{#each ../sanggaTypeArr}}		
...
<c:out value="<script type='text/template' id='tmplTableSupplyTrendDetail'>" escapeXml="false" />
{{#each dataArr}}
