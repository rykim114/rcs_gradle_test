...
//		$("#arrFileUrl",opener.document).val(fileInfo.imageurl);
		var inputs = '<li>';
		inputs += '<input type="hidden" name="i_arrImageurl" value="'+ fileInfo.imageurl +'" />';
		inputs += '<input type="hidden" name="i_arrFilesize" value="'+ fileInfo.filesize +'" />';
		inputs += '<input type="hidden" name="i_arrFilename" value="'+ fileInfo.filename +'" />';
		inputs += '<input type="hidden" name="i_arrOriginalPath" value="'+ fileInfo.upload_path +'" />';
		inputs += '<input type="hidden" name="i_arrOriginalName" value="'+ fileInfo.originalName +'" />';
		inputs += '<input type="hidden" name="i_arrOriginalNameExtension" value="'+ fileInfo.originalNameExtension +'" />';
		...
		$("#fileList",opener.document).append(inputs);
		closeWindow();
	}
