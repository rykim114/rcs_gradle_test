...
//                reportUrl = ipAddr + realUrl;
            ...
            */
            ...
            String wasKind=AIScriptManager.aiProps.getProperties("WebApplicationServer.Kind");
            if(wasKind!=null && wasKind.indexOf("weblogic")!=-1) {
                String[] weblogicInfo=wasKind.split(",");
                if(weblogicInfo.length>1) {
                    conn = (HttpURLConnection) new URL("https", weblogicInfo[1], AIFunction.atoi(weblogicInfo[2]), reportUrl, new sun.net.www.protocol.https.Handler()).openConnection();
                }
                else
