...
L.Draw.Circle = L.Draw.SimpleShape.extend({
	...
	_drawShape: function (latlng) {
		...
		if (distance >= L.drawLocal.draw.handlers.circle.distanceLimit ){
			distance = L.drawLocal.draw.handlers.circle.distanceLimit;
		}
...
L.Edit.PolyVerticesEdit = L.Handler.extend({
	...
	_onMarkerDrag: function (e) {
		...
		// XXX: 없는 변수여서 제외했는데 부작용이 뭘지 확인 필요
