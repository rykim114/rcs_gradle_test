			...
			return z.xAsync('dawulmap', 'zeons_마커생성', 'select', param, 'json2').always(function() {
				...
				for(var i = 0; i < resp.length; i++){
					...
					*/	
					...
					html_ += "<div class='flag-body popupopen'>";
					...
					html2_ += "<div class='z_leaflet-popup' id='"+popid+"'>";
					html2_ += "<div class='z_leaflet-popup-content'>";
					html2_ += "<div class='z_leaflet-content-box'>";
					html2_ += "<div class='z_leaflet-header'>";
					html2_ += "<h3 id=" + resp[i].xy + ">-</h3>";
					html2_ += "<strong>"+popdate+" : <span>" + resp[i].w_date + "</span></strong>";
					html2_ += "</div>";
					html2_ += "<div class='leaflet-body " + resp[i].xy + "' data-scroll='true' data-height='155' data-mobile-height='155' style='height:155px;'>";
					html2_ += "</div>";
					html2_ += "<div class='z_leaflet-footer'>";
					html2_ += "<button type='button' class='btn btn-outline-secondary btn-lg px-11 font-weight-bold' id='mapInfo1'>더보기</button>";
					html2_ += "</div>";
					html2_ += "</div>";
					html2_ += "<div class='t_arrow'></div>";
					html2_ += "</div>";
					html2_ += "<button class='z_leaflet-popup-close-button'><i class='ki ki-close'></i></button>";
					html2_ += "</div>";	
					html2_ += "</div>";														
