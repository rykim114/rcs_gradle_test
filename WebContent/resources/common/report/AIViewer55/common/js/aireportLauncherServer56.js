    ...
    var aireportVersion = 56023;

    //사용자 setting...
    //*****************************************************************************************
    var installUrl="http://192.168.0.29:8085/viewer60/AIUpdate56/NonActiveXInstall.html";
    var viewerSetup="AIViewer56Setup.exe";
    var fullSetup="AIViewer56Install.exe";

    //dlawoejr 2015.09.24
    var sessionIDGetUrl="/viewer60/AIUpdate56/AIsessionIDGet56.jsp";
    var updateUrl="http://192.168.0.29:8085/viewer60/AIUpdate56/";
    var installCheckUrl="http://127.0.0.1:59481/AIInstallCheck";
    var paramSaveUrl="http://localhost:59481/AIParamSave";
    var paramGetUrl="http://localhost:59481/AIViewerParamGet";
    //var paramSaveUrl="http://192.168.0.29:8085/viewer60/AIUpdate56/AIParamSave.jsp";
    //var paramGetUrl="http://192.168.0.29:8085/viewer60/AIUpdate56/AIViewerParamGet.jsp";
    //******************************************************************************************
            ...
            success: function (result) {
                ...
                $.ajax({
                    ...
                    success: function (result) {
                        ...
                        cgi_params = "param=" + result.target;
