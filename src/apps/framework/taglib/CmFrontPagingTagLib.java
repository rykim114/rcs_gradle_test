...
public class CmFrontPagingTagLib extends TagSupport{
	...
	public int doEndTag() throws JspException
	{
		...
		try{
			...
			String prevLabel 		= "<img src=\""+CmPathInfo.getCOMMON_IMG_URL()+"common/p_prev.png\" alt=\"prev\">";//이전 페이지
			String nextLabel 		= "<img src=\""+CmPathInfo.getCOMMON_IMG_URL()+"common/p_next.png\" alt=\"next\">";//다음 페이지
			...
			if(pageTotal > 0) {
				...
				for (int i = pageGroupStart; i < pageGroupEnd; i++) {
					if(i == nowPageNo) {
						sb.append("\n").append("<li class=\"n_page on\"><a class=\"no-border\" href=\"javascript:;\">"+i+"</a></li>");
					} else {
						sb.append("\n").append(makeLink(i, "" + i + "", ""));
					}
				}
	...
	public String makeLink(int page, String label, String className) {
		...
		tmp.append("<li class=\"n_page\"><a href=\"javascript:"+getCallFuncName()+"('" + page + "');\">"+page+"</a></li>");
	...
	public String makeNotLink(String label, int page, boolean has, String flag) {
		...
		if(has) {
			...
			tmp.append("<li class=\""+classnm+"\"><a href=\"javascript:"+getCallFuncName()+"('" + pageno + "')\" >");
			tmp.append(label).append("</a></li>");
		} else {
			if(flag.equals("P")) {
				classnm	=	"prev";
			} else {
			...
			tmp.append("<li class=\""+classnm+"\"><a href=\"javascript:;\">");
			tmp.append(label).append("</a></li>");
		}
